...
print("I'll assume that this is not caps sensitve. Also, I'll assume that an empty string is a valid isogram")
...
assert is_isogram("telecomMunications") == False # Should not be cap sensitive
